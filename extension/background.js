...
chrome.storage.onChanged.addListener((changes, area) => {
    ...
    const syncKeys = ['blockedSites', 'blockedCategories', 'blockedKeywords', 'usageLimits', 'isBlockingEnabled', 'isWhitelistMode', 'focusWhitelist', 'focusSession', 'settings', 'duration', 'customBlockPage', 'ext_blockSites', 'ext_focusMode', 'ext_insights'];
...
async function refreshFromCloud() {
    try {
        ...
        const syncKeys = ['blockedSites', 'blockedCategories', 'blockedKeywords', 'usageLimits', 'isBlockingEnabled', 'isWhitelistMode', 'focusWhitelist', 'focusSession', 'settings', 'schedule', 'duration', 'customBlockPage'];
